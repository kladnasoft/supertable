# route: supertable.reflection.quality.scheduler
...
def notify_ingest(r, org: str, sup: str, table_name: str) -> None:
    ...
    """
    try:
        from supertable.reflection.quality.config import DQConfig
...
def _run_quick_check(r, org: str, sup: str, table_name: str, dqc) -> None:
    ...
    from supertable.reflection.quality.anomaly import detect_anomalies, detect_schema_drift
