...
class TestSettingsDataclass:
    ...
    def test_documented_defaults(self) -> None:
        ...
        assert s.SUPERTABLE_ISLAND_CACHE_MAX_BYTES == 0
        ...
        assert s.SUPERTABLE_ISLAND_RANGE_CACHE_MAX_BYTES == 0
        assert s.SUPERTABLE_ISLAND_MEMORY_FRACTION == 1.0
        assert s.SUPERTABLE_ISLAND_GLOBAL_MEMORY_FRACTION == 1.0
        assert s.SUPERTABLE_ISLAND_MAX_RESULT_BYTES == 0
