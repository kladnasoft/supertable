...
class Settings:
    ...
    # Fleet-safety gate for transitioning a legacy table to segmented
    ...
    SUPERTABLE_DEFAULT_LIMIT: int = 10000        # SUPERTABLE_DEFAULT_LIMIT
    SUPERTABLE_MAX_LIMIT: int = 10000            # SUPERTABLE_MAX_LIMIT
...
def _build_settings() -> Settings:
    ...
    return Settings(
        ...
        SUPERTABLE_DEFAULT_LIMIT=_env_int("SUPERTABLE_DEFAULT_LIMIT", 10000),
        SUPERTABLE_MAX_LIMIT=_env_int("SUPERTABLE_MAX_LIMIT", 10000),
